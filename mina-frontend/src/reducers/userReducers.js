...
export const userSignInReducer = (state = {}, action) => {
    ...
    switch (action.type) {
        ...
        case USER_SIGNIN_SUCCESS:
            //if the sign in was successful we want to stop loading and fill in userInfo in state with the payload of this action which is the returned user data from the server
            return {
        ...
        case USER_SIGNOUT:
            //in case of a sign out we return an empty object that actually removes all the data including userInfo from the state
            return {};
        default:
...
export const userSignUpReducer = (state = {}, action) => {
    ...
    switch (action.type) {
        case USER_SIGNUP_REQUEST:
            //in case of a sign-up request we want to set loading to true
            return {
                loading: true
            };
        case USER_SIGNUP_SUCCESS:
            //if the sign-up was successful we want to stop loading and fill in userInfo in state with the payload of this action which is the returned user data from the server
            return {
                loading: false, userInfo: action.payload
            };
        case USER_SIGNUP_FAILURE:
            //if the sign-up request fails we want to stop loading and we want to fill error with the payload of this action
            return {
                loading: false, error: action.payload
            };
        default:
